...
- **Developer:** Peniel Samuel ([@Penielka](https://github.com/Penielka))
- **Repository URL:** [https://github.com/Penielka/whitebeltRisein_1](https://github.com/Penielka/whitebeltRisein_1)
...
```bash
git clone https://github.com/Penielka/whitebeltRisein_1.git
cd whitebeltRisein_1
```
